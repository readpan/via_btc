...
def get_account_hashrate():
    ...
    # r = '{"code":0,"data":{"active_workers":3,"coin":"BTC","hashrate_10min":"44625511932668","hashrate_1hour":"41468691881365","hashrate_24hour":"41780627402430","unactive_workers":0},"message":"OK"}'
    # j = json.loads(r)['data']
    out = ''
    out += '活跃机器：' + str(j["active_workers"]) + '<br>'
    out += '一小时算力：' + str(float(j["hashrate_1hour"]) / 1000000000000) + '<br>'
    return out
...
def hello():
    ...
    responses += get_request_ip()
    to_send_msg = 'https://sc.ftqq.com/SCU61940T3553c7eb29d0115392096e47a7f60fd35e54a4c36cd76.send?text=' + time.asctime(
        time.localtime(time.time())) + '&desp=' + responses
